...
class Deck {
	 ...
	 */
	public Deck merge(Deck d2) { // 15.1 turn merge into object method, see comments in mergeSort()
		// create the new deck
	...
	public PokerHand deal(int numCards, boolean print) {
		PokerHand hand = new PokerHand(numCards);
